...
public class CalculatorBrain implements CalculatorDigitClickListener, CalculatorOperatorClickListner, ClearContentListener {
	...
	@Override
	public void clearContent(String value) {
		// TODO Auto-generated method stub
		if(value.contentEquals("AC")) {
			if(displayChangeListner != null) {
				setValue("0");
				updateDisplay();
			}
